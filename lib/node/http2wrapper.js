...
function Request(protocol, options) {
  ...
  delete options.path;
  var sessionOptions = (0, _objectSpread3.default)({}, options);
...
Request.prototype.getFrame = function () {
  ...
  var method = (_method = {}, (0, _defineProperty2.default)(_method, HTTP2_HEADER_PATH, this.path), (0, _defineProperty2.default)(_method, HTTP2_HEADER_METHOD, this.method), _method);
