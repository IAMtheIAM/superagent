...
Request.prototype.pfx = function (cert) {
  if ((0, _typeof2.default)(cert) === 'object' && !Buffer.isBuffer(cert)) {
    this._pfx = cert.pfx;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 4;
            return this._shouldRetry(err, res);
          ...
          case 5:
            ...
            return _context.abrupt("return", this._retry());

          case 7:
            // Avoid the error which is emitted from 'socket hang up' to cause the fn undefined error on JS runtime.
            fn = this._callback || noop;
            this.clearTimeout();
            ...
            return _context.abrupt("return", console.warn('superagent: double callback bug'));
          ...
          case 11:
            ...
            if (!err) {
              try {
                if (!this._isResponseOK(res)) {
                  msg = 'Unsuccessful HTTP response';
            ...
            return _context.abrupt("return", fn(null, res));
...
Request.prototype.connect = function (connectOverride) {
  ...
  } else if ((0, _typeof2.default)(connectOverride) === 'object') {
